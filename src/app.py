...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer training, drills, and inter-school matches",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Team practices focusing on skills, strategy, and league play",
    ...
    "Robotics Club": {
        "description": "Design and build robots; learn electronics and programming for competitions",
